  ...
  return (
    <div className="min-h-screen relative">
      ...
      <section className="px-6 py-20 md:py-32 text-white">
        <h1 className="font-clash text-3xl md:text-5xl font-bold max-w-3xl mb-8 text-balance">
          Seasoned creatives. Free from the fishy layers of an agency.
        </h1>
        <div className="wave-bg h-1 w-24 mb-8" />
        <p className="font-clash text-lg md:text-xl max-w-2xl mb-12 text-balance">
      ...
      <section className="px-6 py-20 wave-bg">
        <h2 className="font-clash text-xl md:text-2xl font-bold mb-8 text-white">Who we're for:</h2>
        <p className="font-clash text-lg max-w-2xl mb-12 text-white">
          Marketer seeking a collaborative, fast-paced, AI-embracing, and cost-effective creative consultancy.
        </p>

        <h2 className="font-clash text-xl md:text-2xl font-bold mb-8 text-white">How you can use us:</h2>
        <div className="space-y-6 max-w-2xl">
          <p className="font-clash text-lg flex items-start gap-4 text-white">
      ...
      <section className="px-6 py-20 text-white">
        <h2 className="font-clash text-3xl md:text-4xl font-bold max-w-3xl mb-8 text-balance">
          Our work:
        </h2>
        <div className="wave-bg h-1 w-24 mb-8" />
        <p className="font-clash text-lg md:text-xl max-w-2xl mb-12 text-balance">
        ...
        <p className="font-clash text-lg max-w-2xl mb-2">
      ...
      <section className="px-6 py-12 text-white">
        <div className="space-y-4">
          <a 
            ...
            className="font-clash flex items-center gap-2 hover:text-primary transition-colors"
          >
            <Mail size={20} />
